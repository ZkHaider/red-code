package com.zkhaider.red_code.fab;
...
public class FloatingActionMenu extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        mAddButtonPlusColor = attr.getColor(R.styleable.FloatingActionMenu_fab_addButtonPlusIconColor, getColor(android.R.color.white));
        mAddButtonColorNormal = attr.getColor(R.styleable.FloatingActionMenu_fab_addButtonColorNormal, getColor(android.R.color.holo_blue_dark));
        mAddButtonColorPressed = attr.getColor(R.styleable.FloatingActionMenu_fab_addButtonColorPressed, getColor(android.R.color.holo_blue_light));
        mExpandDirection = attr.getInt(R.styleable.FloatingActionMenu_fab_expandDirection, EXPAND_UP);
        mLabelsStyle = attr.getResourceId(R.styleable.FloatingActionMenu_fab_labelStyle, 0);
        attr.recycle();
