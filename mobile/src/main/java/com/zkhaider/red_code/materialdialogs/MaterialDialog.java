...
import com.zkhaider.red_code.materialdialogs.base.DialogBase;
...
public class MaterialDialog extends DialogBase implements View.OnClickListener {
    ...
    protected final View titleFrame;
    ...
    protected MaterialDialog(Builder builder) {
        ...
        if (mBuilder.selector == null)
            mBuilder.selector = DialogUtils.resolveDrawable(getContext(), R.attr.md_selector);

        if (mBuilder.selector == null) {
            final Resources r = mBuilder.context.getResources();
            switch (mBuilder.theme) {
                case LIGHT:
                    mBuilder.selector = r.getDrawable(R.drawable.md_selector);
                    break;
                case DARK:
                default:
                    mBuilder.selector = r.getDrawable(R.drawable.md_selector_dark);
                    break;
            }
        }

        if (mBuilder.btnSelector == null)
            mBuilder.btnSelector = DialogUtils.resolveDrawable(getContext(), R.attr.md_btn_selector);

        if (mBuilder.btnSelector == null) {
            final Resources r = mBuilder.context.getResources();
            switch (mBuilder.theme) {
                case LIGHT:
                    mBuilder.btnSelector = r.getDrawable(R.drawable.md_btn_selector);
                    break;
                case DARK:
                default:
                    mBuilder.btnSelector = r.getDrawable(R.drawable.md_btn_selector_dark);
                    break;
            }
        }
...
//          } TODO else if RecyclerView {
    ...
    private boolean invalidateActions() {
        ...
        if (mBuilder.positiveText != null) {
            ...
            setBackgroundCompat(positiveButton, isStacked ? mBuilder.selector : mBuilder.btnSelector);
        ...
        if (mBuilder.neutralText != null) {
            ...
            setBackgroundCompat(neutralButton, isStacked ? mBuilder.selector : mBuilder.btnSelector);
        ...
        if (mBuilder.negativeText != null) {
            ...
            setBackgroundCompat(negativeButton, isStacked ? mBuilder.selector : mBuilder.btnSelector);
    ...
    public static class Builder {
        ...
        public Builder selectorRes(@DrawableRes int selector) {
            return selector(this.context.getResources().getDrawable(selector));
        }
        ...
        public Builder btnSelectorRes(@DrawableRes int btnSelector) {
            return btnSelector(this.context.getResources().getDrawable(btnSelector));
        }
